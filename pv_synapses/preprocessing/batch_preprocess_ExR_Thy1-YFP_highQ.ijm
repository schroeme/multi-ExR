...
parent = "A:/Margaret/mExR/2024-08_PVGFP_SSC-HPC_GluA1_synapes_Margaret/"; //parent folder where raw microscope images are stored (e.g. in .nd2 format)
parentout = "A:/Margaret/mExR/2024-08_PVGFP_SSC-HPC_GluA1_synapes_Margaret/preprocessed/"; //where to save the images
//reg = "ctx"; //specify the brain region here (you can delete this from the final filename in the last section if you want)

folderList = newArray(
	"PVGFP-HPC-GluA1-Mouse01-Synapses-ROI/",
	"PVGFP-HPC-GluA1-Mouse02-Synapses-ROI/",
	"PVGFP-SSC-GluA1-Mouse01-Synapses-ROI/",
	"PVGFP-SSC-GluA1-Mouse02-Synapses-ROI/"
	);
