...
// Last modified by MES on 8/31/24

run("Close All");
setBatchMode(true);

parent = "A:/Margaret/mExR/2024-08_SSC & HPC_Thy1-YFP + 4 Target_Synapse ROI/"; //parent folder where raw microscope images are stored (e.g. in .nd2 format)
parentout = "A:/Margaret/mExR/2024-08_SSC & HPC_Thy1-YFP + 4 Target_Synapse ROI/preprocessed/"; //where to save the images
