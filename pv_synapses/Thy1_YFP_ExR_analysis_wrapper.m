%%  WRAPPER for analyzing Thy1-YFP (NOT multiiplexed) ExR dataset from July/August 2024 %% 

% Last modified by Margaret Schroeder on 8/16/24
...
%params.parentfolder = 'A:/Margaret/mExR/2024-08_PVGFP_SSC-HPC_GluA1_synapes_Margaret/preprocessed/';
params.parentfolder = 'A:/Margaret/mExR/2024_07_Thy1GFP_SSC-HPC_GluA1_synapses_Margaret/preprocessed/';
...
params.lowerlim=725; %for Cav2.1 synapse identification
params.target_sizefilt = 0;
params.target_lowerlim = 200; %for target channel

params.savemasks=1;
params.savetargetmasks=1;
% params.maskfolder='A:/Margaret/mExR/2024-08_PVGFP_SSC-HPC_GluA1_synapes_Margaret/GFP_masks/'; %GFP+ PN dendrites defined by Menglong (note these are 2D for now)
% params.targetoutfolder = 'A:/Margaret/mExR/2024-08_PVGFP_SSC-HPC_GluA1_synapes_Margaret/target_masks_nofilt/';
% params.outfolder = 'A:/Margaret/mExR/2024-08_PVGFP_SSC-HPC_GluA1_synapes_Margaret/syn_masks/';
params.maskfolder='A:/Margaret/mExR/2024_07_Thy1GFP_SSC-HPC_GluA1_synapses_Margaret/GFP_masks/'; %GFP+ PN dendrites defined by Menglong (note these are 2D for now)
params.targetoutfolder = 'A:/Margaret/mExR/2024_07_Thy1GFP_SSC-HPC_GluA1_synapses_Margaret/target_masks_nofilt/';
params.outfolder = 'A:/Margaret/mExR/2024_07_Thy1GFP_SSC-HPC_GluA1_synapses_Margaret/syn_masks/';
...
save('A:/Margaret/mExR/2024_07_Thy1GFP_SSC-HPC_GluA1_synapses_Margaret/analyzed_data_nofilt_20240831.mat','data');
